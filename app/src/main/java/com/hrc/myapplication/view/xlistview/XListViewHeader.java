...
public class XListViewHeader extends LinearLayout{
    ...
    public final static int STATE_NORMAL=0;//normal  未刷新状态
    public final static int STATE_READY=1;//ready  准备刷新状态
    public final static int STATE_REFRESHING=2;//refreshing  正在刷新
